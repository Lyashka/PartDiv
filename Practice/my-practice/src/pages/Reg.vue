  ...
  <div class="container">
    <div class="row">
      <div class="mx-auto">
        <div class="my-md-5">
          <div class="card ">
            <div style="padding: 0rem 3rem; padding-top: 1rem;">
              <div class="row">
                <div class="col-auto">
                  <a href="/">
                    <div style="padding-bottom: 20px;"><svg  x="0px" y="0px"
            ...
            <div class="px-4 px-md-5 pb-4">
              ...
              <ul class="nav nav-pills" id="registrationTabs" role="tablist" style="margin-bottom: 15px;">
                <li class="nav-item " role="presentation">
                  <a class="nav-link" :class="{active: divisionActive}" id="students-tab" data-toggle="tab" href="#students" role="tab" aria-controls="students" aria-selected="true" aria-expanded="true" @click="openDivisionWindow">Подразделение</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" :class="{active: partnerActive}" id="workers-tab" data-toggle="tab" href="#workers" role="tab" aria-controls="workers" aria-selected="false" aria-expanded="false" @click="openPartnerWindow">Партнерам</a>
                </li>
              </ul>
